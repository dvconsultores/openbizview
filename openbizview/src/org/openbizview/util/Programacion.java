...
public class Programacion extends Bd implements Serializable {
	...
	public Programacion() throws SchedulerException {
		...
		streamMenu.forEach(x -> {
			...
			if(segu.listMenu.get(x).opcMenu.equals("M24") && segu.listMenu.get(x).vistaMenu.equals("1")) {
  ...
  //Coneccion a base de datos
     ...
     **/ 	
  	public void counter(Object filterValue )  {
        ...
        querypg += " from t_programacion a, mailgrupos b";
        querypg += " where a.idgrupo=b.idgrupo";
        querypg += " and A.instancia=B.instancia";
        querypg += " and a.job||a.codrep like '%" + ((String) filterValue).toUpperCase() + "%'";
        querypg += " and a.codrep like '" + vecrepf[0] + "%'";
        querypg += " and a.frecuencia like '" + veccfrecf[0] + "%'";
        querypg += " and cast(a.idgrupo as text) like '" + vecgrupf[0] + "%'";
        querypg += " and a.disparador like '" + vltrigger + "%'";

...
import org.openbizview.util.Bvt010;
	...
	public List<UISelectItem> getCatalogs() {
		if (catalogItems == null) {
			...
			ResourceBundle messages = context.getApplication()
					.getResourceBundle(context, "msgp");
            Bvt010 datasource = new Bvt010();
			try {//Customizado bv7
				List<Bvt010> catalogs = datasource.selectPivotAcces();
				...
				for (Bvt010 catalog : catalogs) {
					UISelectItem item = new UISelectItem();

					item.setItemValue(catalog.getValue());

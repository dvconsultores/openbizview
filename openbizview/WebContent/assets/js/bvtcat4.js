...
function enviar(vT0,vT1,vT2,vT3,vT4,vT5,vT6,vT7){
	  ...
	  updateInput('formbvtcat4:bcodcat1_input', '#b6c6c0');
	  updateInput('formbvtcat4:bcodcat2_input', '#b6c6c0');
	  updateInput('formbvtcat4:bcodcat3_input', '#b6c6c0');
	  updateInput('formbvtcat4:codcat4', '#b6c6c0');
	}

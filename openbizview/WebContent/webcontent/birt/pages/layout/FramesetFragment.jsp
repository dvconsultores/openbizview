...
<%
        ...
        if (sesionOk.getAttribute("usuario") == null) {
           sesionOk.invalidate();
out.print("<script> top.location.href ='/openbizview/login.xhtml'; </script>");
        } else {
            usuario = (String) sesionOk.getAttribute("usuario");
        }
        session.setMaxInactiveInterval(5400000);
...
<HTML>
	<HEAD>
		...
		<!-- Bootstrap -->
		<link href="../resources/ccs/bootstrap.min.css" rel="stylesheet"/>
		<link href="../resources/ccs/bootstrap-theme.min.css" rel="stylesheet"/>
		<script src="../resources/js/bootstrap.min.js" type="text/javascript"></script>
		<link href="../resources/font-awesome-4.2.0/css/font-awesome.min.css" rel="stylesheet"/>
<script>
function hiderow(form, ord){

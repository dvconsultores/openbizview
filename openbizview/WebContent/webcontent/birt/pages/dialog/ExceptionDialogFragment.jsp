							...
							<TR>
								<TD>
									<DIV ID="showTraceLabel" CLASS="birtviewer_exception_dialog_label">
										<%= BirtResources.getMessage( ResourceConstants.EXCEPTION_DIALOG_SHOW_STACK_TRACE, valorCookie ) %> 
									</DIV>																				
									<DIV ID="hideTraceLabel" CLASS="birtviewer_exception_dialog_label" STYLE="display:none">
										<%= BirtResources.getMessage( ResourceConstants.EXCEPTION_DIALOG_HIDE_STACK_TRACE, valorCookie ) %> 
									</DIV>									
								</TD>
							</TR>
							<TR>
									...
									<DIV ID="exceptionTraceContainer" STYLE="display:none">
										<TABLE WIDTH="100%">
											<TR>
												<TD>
													<%= 
														BirtResources.getMessage( ResourceConstants.EXCEPTION_DIALOG_STACK_TRACE, valorCookie )
													%><BR>
												</TD>
											</TR>
											<TR>

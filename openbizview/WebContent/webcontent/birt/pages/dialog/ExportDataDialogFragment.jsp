				...
				<TABLE ID="tabs" CELLSPACING="0" CELLPADDING="2">
					<TR HEIGHT="20px">
						<TD CLASS="birtviewer_dialog_tab_selected" NOWRAP>
							<%= 
								BirtResources.getMessage( "birt.viewer.dialog.exportdata.tab.field", valorCookie )
							%>
						</TD>
						<TD CLASS="birtviewer_dialog_tab_normal">
							<%= BirtResources.getMessage( "birt.viewer.dialog.exportdata.tab.filter", valorCookie )%>
						</TD>
					</TR>
				</TABLE>
			</TD>
				...
				<DIV ID="aaacontent">
					<DIV >
						<TABLE CELLSPACING="2" CELLPADDING="2" CLASS="birtviewer_dialog_body">
							...
							<TR>
								<TD>
									<%= BirtResources.getMessage( "birt.viewer.dialog.exportdata.availablecolumn", valorCookie )%>
								</TD>
								<TD></TD>
								<TD>
									<%= BirtResources.getMessage( "birt.viewer.dialog.exportdata.selectedcolumn", valorCookie )%>
								</TD>
							</TR>
							<TR>
								<TD VALIGN="top">
							...
							<TR>
								<TD COLSPAN="3" STYLE="font-size:7pt">
									<%= BirtResources.getMessage( "birt.viewer.dialog.exportdata.format", valorCookie )%>
								</TD>
							</TR>
							<TR HEIGHT="5px"><TD></TD></TR>
						</TABLE>
